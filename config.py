...
# Fallback stock lists (Latest Nifty 50 composition - Updated November 14, 2025)
FALLBACK_NIFTY_50 = [
    ...
    'TMCV.NS', 'TRENT.NS', 'ULTRACEMCO.NS', 'WIPRO.NS'
]

FALLBACK_NIFTY_NEXT_50 = [
    'ABB.NS', 'ADANIGREEN.NS', 'AMBUJACEM.NS', 'APOLLOTYRE.NS', 'AUBANK.NS',
    'BANDHANBNK.NS', 'BERGEPAINT.NS', 'BLAK.NS', 'BOSCHLTD.NS', 'CENTRALBK.NS',
    'CHOLAFIN.NS', 'COLPAL.NS', 'CRISIL.NS', 'DABUR.NS', 'DIXON.NS',
    'DLF.NS', 'ESCORTS.NS', 'GICRE.NS', 'GODREJCP.NS', 'HAVELLS.NS',
    'HDFCAMC.NS', 'ICICIPRULI.NS', 'IDFCFIRSTB.NS', 'INDIGO.NS', 'IRCON.NS',
    'JINDALSTEL.NS', 'JKCEMENT.NS', 'LICI.NS', 'LUPIN.NS', 'MARICO.NS',
    'MCX.NS', 'MCDOWELL-N.NS', 'MUTHOOTFIN.NS', 'NMDC.NS', 'NYKAA.NS',
    'OBEROIRLTY.NS', 'PAGEIND.NS', 'PETRONET.NS', 'PIDILITIND.NS', 'PNB.NS',
    'PNBHOUSING.NS', 'RECLTD.NS', 'SBICARD.NS', 'SIEMENS.NS', 'TATAPOWER.NS',
    'TORNTPHARM.NS', 'VBL.NS', 'VEDL.NS', 'VOLTAS.NS', 'ZYDUSLIFE.NS'
]

FALLBACK_BSE_SENSEX = [
    'ADANIPORTS.BO', 'ASIANPAINT.BO', 'AXISBANK.BO', 'BAJAJ-AUTO.BO', 'BAJFINANCE.BO',
    'BHARTIARTL.BO', 'HCLTECH.BO', 'HDFCBANK.BO', 'HINDUNILVR.BO', 'ICICIBANK.BO',
    'INDUSINDBK.BO', 'INFY.BO', 'ITC.BO', 'JSWSTEEL.BO', 'KOTAKBANK.BO',
    'LT.BO', 'MARUTI.BO', 'NESTLEIND.BO', 'NTPC.BO', 'POWERGRID.BO',
    'RELIANCE.BO', 'SBIN.BO', 'SUNPHARMA.BO', 'TATAMOTORS.BO', 'TATASTEEL.BO',
    'TCS.BO', 'TECHM.BO', 'TITAN.BO', 'ULTRACEMCO.BO', 'WIPRO.BO'
]
